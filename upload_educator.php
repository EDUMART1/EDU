		...
		<div class="profile">
			...
			<div class="rightdrop">
				...
				<div class="rightdrop-content">
					<a href="educator_profile.php">
						<p style="margin-top:0px;">My Profile</p>
					</a>
	...
	<div class="main">
		...
		<div class="content_layout">
			<form name="upload_educator" action="" method="POST" enctype='multipart/form-data'>
				...
				<div class="form_info">
					<p>By submitting your videos to EDU MART, you acknowledge that you agree to EDU MART's Terms of Service and Community Guidelines.</p>
					<p>Please be sure not to violate others' copyright or privacy rights. </p>
					<p style="color: red;">For the profit, EDU MART will take 20% of the profit, educator can get 80% of profit</p>
				</div>
